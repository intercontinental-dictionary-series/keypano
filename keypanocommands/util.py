...
# Data modules
def get_language_all(wordlist):
    languages = wordlist.cols
    # Hack to remove Indo-European donor languages.
    donors = ["Spanish", "SpanishLA", "Portuguese", "PortugueseBR"]
        ...
        with open(out_file_path, 'wt') as wlfile:
            ...
            with open(file_path) as file:
                ...
                for row in rdr:
                    ...
                    # add to output file.
                    new_row = row[1:]
                    # Add empty borrowed_score, donor_language, and donor_value
