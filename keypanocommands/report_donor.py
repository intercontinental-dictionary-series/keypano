            ...
            for idx, hits in idxs.items():
                ...
                for donor, dist, donor_word in hits:
                    ...
                    if dist <= threshold:  # Only need 1 donor word < threshold.
                        anyPred = True
                    # print(families[language], language, concept, word, pred, loan, donor, dist, donor_word)
                ...
                for row in tmp_words:
                    ...
                    if row[1] < threshold or (report_limit and row[1] <= report_limit):
                        ...
                        # print(f"Words {language}, {concept_name}, {word},
                        # {donor_candidate_}, {candidate_tokens_},
                        # {donor_language}, {donor_value}")
            if idxs:
...
def register(parser):
    ...
    parser.add_argument(
        "--series",
        type=str,
        default="devel-pairwise-donor-words",
